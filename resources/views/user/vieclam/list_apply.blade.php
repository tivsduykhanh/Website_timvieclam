                                        ...
                                        <div class="single-post d-flex flex-row">
                                            ...
                                            <div class="details">
                                                <div class="title d-flex flex-row justify-content-between">
                                                    <div class="titles">
                                                        <a href="/user/applied/detail/{{$job->id}}">
                                                ...
                                                <h5>Tên hồ sơ đã nộp: {{ $hoso->tenhoso }}</h5>
                                                ...
                                                <a href="/user/applied/delete/{{$apply->id}}" class="genric-btn danger radius">Huỷ nộp</a>
                                            </div>
                                        </div>
                                    @endif
                                @endif
