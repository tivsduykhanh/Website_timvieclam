                    ...
                    <div class="single-post job-experience">
                        ...
                        <ul>
                            ...
                            <ul class="btns">
                                <li><a href="#"><span class="lnr lnr-heart"></span></a></li>
                                <li>
                                    <a class="selectHoso" onclick="myFunction()">Apply</a>
                                    <a id="myDialog">
                                        <form action="/user/apply" class="form-container" method="POST">
                                                @csrf
                                                <h1>Chọn hồ sơ</h1>

                                                <label><b>Tên hồ sơ</b></label>
                                                <input type="hidden" id="id" name="id" value="{!! $detailjob->id !!}" />
                                                <select name="tenhoso" id="tenhoso" class="single-input" required>
                                                    @foreach($list_hoso as $key => $hoso)
                                                        <option value="{{$hoso->id}}" >{{$hoso->tenhoso}}</option>
                                                    @endforeach
                                                </select>

                                                <button style="margin-top: 20px" type="submit" class="btn">Xác nhận</button>
                                        </form>     
                                    </a>
                                </li>
                            </ul>
                            <li>
                                ...
                                <li>
                                        <span>Ngày đăng bài: {{ $detailjob->created_at }}</span>
                                </li>
                        </ul>
                    </div>
                </div>
