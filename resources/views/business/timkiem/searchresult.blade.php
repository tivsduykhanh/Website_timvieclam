			...
			<div class="row search-page-top d-flex align-items-center justify-content-center">
				<div class="banner-content col-lg-12">
					...
					<p class="text-white link-nav">
						<a href="/business">Home </a> <span class="lnr lnr-arrow-right"></span> <a> {{$title}}</a>
					</p>	
					@include('business.timkiem.search')
					<p class="text-white">{{$jobs->count()}} kết quả tìm kiếm cho <span>"{{$searchs}}"</span></p>
				</div>											
			</div>
		</div>
	</section>
							...
							<div class="single-post d-flex flex-row">
								...
								<div class="details">
									<div class="title d-flex flex-row justify-content-between">
										<div class="titles">
											<a href="/business/job/detail/{{ $job->id }}"><h4>{{$job->tencongviec}}</h4></a>
											<h6>{{$job->tencongty}}</h6>
										</div>
										{{-- <ul class="btns">
