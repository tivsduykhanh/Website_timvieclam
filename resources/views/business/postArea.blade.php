	...
	<div class="single-slidebar">
			...
			<ul class="cat-list">
					@foreach ($tinhthanhs as $tinhthanh)
							<li><a name="timtinhthanh" class="justify-content-between d-flex" href="/business/search">
											<p value="1">{{ $tinhthanh->tentinhthanh }}</p><span>37</span>
									</a></li>
					@endforeach
			</ul>
	</div>
	...
	<div class="single-slidebar">
			...
			<ul class="cat-list">
					@foreach ($loainganhs as $loainganh)
							<li><a class="justify-content-between d-flex" href="/business/search">
											<p>{{ $loainganh->tennganh }}</p><span>37</span>
									</a></li>
					@endforeach
