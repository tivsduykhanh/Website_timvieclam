	...
	<section class="contact-page-area section-gap">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8">
					<form class="form-area " action="/business/contacts" method="POST" class="contact-form text-right">
						@csrf
						<div class="row">	
							<div class="col-lg-12 form-group">
								...
								<input name="subject" placeholder="Nhập tiêu đề" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nhập tiêu đề'" class="common-input mb-20 form-control" required="" type="text">
